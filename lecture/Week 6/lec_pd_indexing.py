...
type(df.loc[:'2020-01-06', ['Close']]) # --><class 'pandas.core.frame.DataFrame'>

x = df.loc['2020-01-06', :'Bday']
print(x)
...
print(df.loc[['b', 'd', 'f', 'j'], 'col1'])
print(type(df.loc[['b', 'd', 'f', 'j'], ['col1']]))
...
print(pd.Series.is_monotonic_increasing)
