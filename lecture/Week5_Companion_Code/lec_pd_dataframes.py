...
print(sorted_ser)
print(sorted_ser.is_monotonic_increasing)

new_ser.sort_index(inplace = True)
print(new_ser)
...
ab = pd.Series(data = b, index = a)
ac = pd.Series(data = c, index = a)
abc = pd.DataFrame({"a": ab, "b": ac})
